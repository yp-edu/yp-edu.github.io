...
Along with this blog post, I have prepared a [repository](https://github.com/yp-edu/marl-cluster-training) with a basic setup of BenchMARL. Please refer to the README for installation instructions and details.
...
>
> I proposed a [config](https://github.com/yp-edu/marl-cluster-training/blob/main/configs/bench:multiwalker.yaml) for the multiwalker benchmark based on object packing similar to how layers are composed. You can use it as a template to create your own benchmarks configs.
